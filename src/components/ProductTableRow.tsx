  ...
  return (
    <TableRow className="hover:bg-muted/50 group">
      <TableCell className="p-2 w-[60px]">
        <div className="relative h-12 w-12 bg-white rounded flex items-center justify-center overflow-hidden border border-border/50">
          {product.imageUrl ? (
      ...
      <TableCell className="font-mono text-xs text-muted-foreground w-[120px]">{product.barcode || "-"}</TableCell>
      <TableCell className="max-w-[200px] xl:max-w-[300px]">
        <div className="flex flex-col gap-1">
          <span className="font-semibold text-sm truncate" title={product.nameHe || product.name}>
      ...
      <TableCell className="text-xs text-muted-foreground w-[120px]">{product.brandHe || product.brand || "-"}</TableCell>
      ...
      <TableCell className="w-[120px]">
        <div className="flex items-center gap-1">
          ...
          <Input 
            ...
            className="w-14 h-8 px-1 text-center text-sm font-medium"
      ...
      <TableCell className="text-left w-[120px]">
        <Button size="sm" className="h-8 px-4 text-xs w-full" disabled={isOutOfStock || qty < 1} onClick={handleAdd}>
